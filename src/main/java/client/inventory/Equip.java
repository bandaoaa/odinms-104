...
public class Equip extends Item implements Serializable {
    ...
    public void setSocket3(int socket) {
        ...
        public void renewPotentials(int 保护潜能位置, int 保护潜能id, int type, int rate, int B级概率, int A级概率, int S级概率, int SS级概率, int 潜能等级概率2, int 潜能等级概率3, int 潜能等级概率4, int 潜能等级概率5) {
        int 现有潜能等级 = -getState();
        int B级 = -17;
        int A级 = -18;
        int S级 = -19;
        ...
        if ((Randomizer.nextInt(100) <= SS级概率) && ((type == 3) || (type == 2))) {
            ...
            if (Randomizer.nextInt(100) <= S级概率) {
                ranks = S级;
            } else {

                if (Randomizer.nextInt(100) <= A级概率) {
                    ranks = A级;
                } else {

                    if (Randomizer.nextInt(100) <= B级概率) {
                        ranks = B级;
                    } else {
                        ranks = B级;
                    }
        ...
        if ((Randomizer.nextInt(100) <= 潜能等级概率2 / 10) && ((type == 3) || (type == 2))) {
            rank2 = SS级;
        } else if (Randomizer.nextInt(100) <= 潜能等级概率2 / 5) {
            rank2 = S级;
        } else if (Randomizer.nextInt(100) <= 潜能等级概率2 / 2) {
            rank2 = A级;
        } else if (Randomizer.nextInt(100) <= 潜能等级概率2) {
            rank2 = B级;
        } else {
            rank2++;
        }
        ...
        if ((Randomizer.nextInt(100) <= 潜能等级概率3 / 20) && ((type == 3) || (type == 2))) {
            rank3 = SS级;
        } else if (Randomizer.nextInt(100) <= 潜能等级概率3 / 10) {
            rank3 = S级;
        } else if (Randomizer.nextInt(100) <= 潜能等级概率3 / 5) {
            rank3 = A级;
        } else if (Randomizer.nextInt(100) <= 潜能等级概率3) {
            rank3 = B级;
        } else {
            rank3++;
        }
    ...
    public int getBlockType() {
        if ((this.blocktype > 7) || (this.blocktype < 0)) {
            return 0;
        }
        return this.blocktype;
    }

    public void setBlockType(int en) {
        if ((en > 7) || (en < 0)) {
            en = 0;
        }
        this.blocktype = en;
    ...
    public int getBlockPotential() {
        if ((this.blockpotential > 7) || (this.blockpotential < 0)) {
            return 0;
        }
        return this.blockpotential;
    }

    public void setBlockPotential(int en) {
        if ((en > 7) || (en < 0)) {
            en = 0;
        }
        this.blockpotential = en;
    }
