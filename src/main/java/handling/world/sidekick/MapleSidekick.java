...
public class MapleSidekick
    ...
    public void broadcast(byte[] packet) {
        Broadcast.sendPacket(this.sidekicks[0].getId(), packet);
        Broadcast.sendPacket(this.sidekicks[1].getId(), packet);
    }
    ...
    public final void eraseToDB() {
        try {
            ...
            Sidekick.eraseSidekick(this.id);
        } catch (SQLException se) {
    ...
    public void applyBuff(MapleCharacter chr) {
        ...
        effects.add(new Pair(MapleBuffStat.力量, Integer.valueOf(levelD * 5)));
        effects.add(new Pair(MapleBuffStat.敏捷, Integer.valueOf(levelD * 5)));
        effects.add(new Pair(MapleBuffStat.智力, Integer.valueOf(levelD * 5)));
        effects.add(new Pair(MapleBuffStat.运气, Integer.valueOf(levelD * 5)));
        effects.add(new Pair(MapleBuffStat.SIDEKICK_PASSIVE, Integer.valueOf(1)));
