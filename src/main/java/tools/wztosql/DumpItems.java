...
public class DumpItems {
	private MapleDataProvider item, string = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("wzpath") + "/String.wz")), character;
