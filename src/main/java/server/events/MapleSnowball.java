                ...
                if (!snowman) {
                    ...
                    if (damage == 0) {
                        ...
                        if ((ball.getPosition() == 255) || (ball.getPosition() == 511) || (ball.getPosition() == 767)) {
                            ...
                            chr.getMap().broadcastMessage(MaplePacketCreator.serverNotice(6, new StringBuilder().append("Congratulations! Team ").append(team == 0 ? "Story" : "Maple").append(" has won the Snowball Event!").toString()));
