                    ...
                    public void run() {
                        ...
                        switch (turn[i]) {
                            ...
                            case ATTACK:
                                ...
                                final boolean extraEffects = (battlers[1].getAbility() != PokemonAbility.ShieldDust) && (s != MonsterStatus.魔击无效);
                                int critChance = 20;
                                ...
                                if (((speshul) || (Randomizer.nextInt(5) == 0)) && (s != MonsterStatus.封印));
                                ...
                                if ((extraEffects) && (Randomizer.nextInt(33 / statDivisor) == 0) && (ee >= 1.0D)) {
                                    switch (element) {
                                        ...
                                        case Normal:
                                        case Immortal:
                                            statt = MonsterStatus.眩晕;
                                            break;
                                        case Enchanted:
                                            statt = MonsterStatus.鬼刻符;
                                            break;
                                        case Devil:
                                        case Fire:
                                            statt = MonsterStatus.烈焰喷射;
                                            break;
                                        case Reptile:
                                        case Mammal:
                                            statt = MonsterStatus.封印;
                                            break;
                                        case Ice:
                                            statt = MonsterStatus.结冰;
                                            break;
                                        case Lightning:
                                            statt = MonsterStatus.影网;
                                            break;
                                        case Fish:
                                            statt = MonsterStatus.速度;
                                            break;
                                        case Plant:
                                        case Spirit:
                                            statt = MonsterStatus.中毒;
                                            break;
                                        case Holy:
                                            statt = MonsterStatus.挑衅;
                                            break;
//                case :
//                  statt = MonsterStatus.魔击无效;
//                  break;
                                        case Dark:
                                            statt = MonsterStatus.恐慌;
                                            break;
                                    }
                                }
                                ...
                                Timer.EtcTimer.getInstance().schedule(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if ((battlers[0].getAbility() != PokemonAbility.NoGuard) && (battlers[i].getAbility() != PokemonAbility.NoGuard)) {
                                            if (battlers[i].getACC() < Randomizer.nextInt(1 + battlers[1].getEVA()) * (s == MonsterStatus.恐慌 ? 2 : 1)) {
                                        ...
                                        if (atk == 0) {
                                            if (battlers[i].getCurrentStatus() == null) {
                                                if ((battlers[0].getAbility() == PokemonAbility.EffectSpore) && (Randomizer.nextInt(100) < 50)) {
                                                    ...
                                                    switch (Randomizer.nextInt(3)) {
                                                        case 0:
                                                            stati = MonsterStatus.中毒;
                                                            break;
                                                        case 1:
                                                            stati = MonsterStatus.影网;
                                                            break;
                                                        case 2:
                                                            stati = MonsterStatus.恐慌;
                                                    }

                                                    MonsterStatusEffect mse = new MonsterStatusEffect(stati, Integer.valueOf(stati == MonsterStatus.中毒 ? (int) (battlers[i].calcHP() / 16L) : 1), MonsterStatusEffect.genericSkill(stati), null, false);
                                            ...
                                            if (battlers[i].getCurrentStatus() == null) {
                                                if ((battlers[0].getAbility() == PokemonAbility.FlameBody) && (Randomizer.nextInt(100) < 50)) {
                                                    MonsterStatus stati = MonsterStatus.烈焰喷射;
                                            ...
                                            if (battlers[i].getCurrentStatus() == null) {
                                                if ((battlers[0].getAbility() == PokemonAbility.PoisonPoint) && (Randomizer.nextInt(100) < 50)) {
                                                    MonsterStatus stati = MonsterStatus.中毒;
                                                    MonsterStatusEffect mse = new MonsterStatusEffect(stati, Integer.valueOf((int) (battlers[i].calcHP() / 16L)), MonsterStatusEffect.genericSkill(stati), null, false);
                                                    battlers[i].setStatus(mse);
                                                    map.broadcastMessage(MaplePacketCreator.serverNotice(6, new StringBuilder().append(battlers[i].getName()).append(" was inflicted with ").append(StringUtil.makeEnumHumanReadable(stati.name())).append(" status!").toString()));
                                            ...
                                            if (battlers[i].getCurrentStatus() == null) {
                                                if ((battlers[0].getAbility() == PokemonAbility.Static) && (Randomizer.nextInt(100) < 50)) {
                                                    MonsterStatus stati = MonsterStatus.影网;
                                                ...
                                                if (battlers[1].getItem() != HoldItem.Pheremone) {
                                                    ...
                                                    if ((battlers[1].getAbility() == PokemonAbility.Synchronize) && (battlers[i].getCurrentStatus() == null)) {
                                                        if ((battlers[0].getAbility() != PokemonAbility.Klutz) && (battlers[i].getItem() != HoldItem.Pheremone)) {
                                                            battlers[i].setStatus(new MonsterStatusEffect(stat, Integer.valueOf((stat == MonsterStatus.中毒) || (stat == MonsterStatus.烈焰喷射) ? (int) (battlers[i].calcHP() / 16L) : 1), MonsterStatusEffect.genericSkill(stat), null, false));
