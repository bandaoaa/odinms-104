...
public class MapleTVEffect {
    ...
    private void broadCastTV(boolean isActive) {
        ...
        if (isActive) {
            ...
            Broadcast.broadcastMessage(MaplePacketCreator.enableTV());
            Broadcast.broadcastMessage(MaplePacketCreator.sendTV(this.user, this.message, this.type <= 2 ? this.type : this.type - 3, this.partner, delay));
            ...
            Broadcast.broadcastMessage(MaplePacketCreator.removeTV());
        }
    }
