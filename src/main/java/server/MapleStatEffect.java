...
//        System.out.println(sourceid);
        ...
        if (ret.skill) {
            switch (sourceid) {
                ...
                case 5001005:
                case 15001003:
                    ret.statups.add(new Pair(MapleBuffStat.疾驰速度, Integer.valueOf(ret.x*2)));
                    ret.statups.add(new Pair(MapleBuffStat.疾驰跳跃, Integer.valueOf(ret.y*2)));
                    break;
                case 11101006:
                case 1101007:
                case 1201007:
    ...
    public boolean isDash() {//疾驰
        return this.sourceid == 5091005 || sourceid == 15001003;
    }
    ...
    public boolean is能量获得() {
        return (this.skill) && ((this.sourceid == 5810001) || (this.sourceid == 5110001)|| (this.sourceid == 15100004));
    }
    ...
    public boolean is骑兽技能() {
        return (this.skill) && ((is骑兽技能_()) || (GameConstants.getMountItem(this.sourceid, null) != 0)) && (!is机械骑兽()) || (((this.sourceid % 20000000 == 1004) || (this.sourceid == 5221006)));
    }
